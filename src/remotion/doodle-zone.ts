 ...
 *   'page'      - a Doodle scene with no drawing: the whole frame, with the
 *                 handwriting set a notch larger than the other looks.
 ...
 */
export type DoodleZone = 'none' | 'page' | 'text-top' | 'text-left';
