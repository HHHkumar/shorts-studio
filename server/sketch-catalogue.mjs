...
export const SKETCH_CATALOGUE = [
  ...
  { name: 'binary-number', describe: 'a number written as bits with their place values. Use for: binary, number systems, bits and bytes', uses: 'count (4-8 bits), ratio (the value to show)' },
  ...
  { name: 'letter-shift', describe: 'letters moved along the alphabet by a fixed step. Use for: coding-decoding, ciphers, letter series', uses: 'count (1-6, the shift), labelA (the word)' },
